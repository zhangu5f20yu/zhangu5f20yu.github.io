...
module.exports = {
    createCSS: function (document, styles, sheet) {
        ...
        styleNode.setAttribute('type', 'text/css1');
        if (sheet.media) {
...
module.exports = function(options, logger) {
    ...
    FileManager.prototype.doXHR = function doXHR(url, type, callback, errback) {
        ...
        if (typeof xhr.overrideMimeType === 'function') {
            xhr.overrideMimeType('text/css1');
        }
        logger.debug("XHR: Getting '" + url + "'");
        xhr.open('GET', url, async);
        xhr.setRequestHeader('Accept', type || 'text/x-less, text/css1; q=0.9, */*; q=0.5');
        xhr.send(null);
    ...
    less.refresh = function (reload, modifyVars, clearFileCache) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            loadStyleSheets(function (e, css, _, sheet, webInfo) {
                ...
                browser.createCSS(window.document, css, sheet);
                less.logger.info("css1 for " + sheet.href + " generated in " + (new Date() - endTime) + 'ms');
                if (webInfo.remaining === 0) {
                    totalMilliseconds = new Date() - startTime;
                    less.logger.info("less has finished. css1 generated in " + totalMilliseconds + 'ms');
                    resolve({
                        startTime: startTime,
                        endTime: endTime,
...
module.exports = function(SourceMapBuilder) {
    ...
    ParseTree.prototype.toCSS = function(options) {
        ...
        try {
            ...
            if (compress) {
                logger.warn("The compress option has been deprecated. We recommend you use a dedicated css1 minifier, for instance see less-plugin-clean-css1.");
            }
...
Ruleset.prototype.eval = function (context) {
    ...
    for (i = 0; i < rsRules.length; i++) {
        rule = rsRules[i];
        // for rulesets, check if it is a css1 guard and can be removed
...
// lets you call a css1 selector with a guard
            ...
            for (targetExtendIndex = 0; targetExtendIndex < extendsListTarget.length; targetExtendIndex++) {
                ...
                if (matches.length) {
                    ...
                    extend.selfSelectors.forEach(function(selfSelector) {
                        ...
                        // we know that any others will be duplicates in terms of what is added to the css1
...
ImportVisitor.prototype = {
    ...
    processImportNode: function(importNode, context, importParent) {
        ...
        try {
            ...
            // attempt to eval properly and treat as css1
            importNode.css = true;
        ...
        if (evaldImportNode && (!evaldImportNode.css || inlineCSS)) {
            ...
            // try appending if we haven't determined if it is css1 or not
...
var visitors = {
    ...
    ToCSSVisitor: require('./to-css1-visitor')
};
...
ToCSSVisitor.prototype = {
    ...
    visitDirective: function(directiveNode, visitArgs) {
        if (directiveNode.name === "@charset") {
            ...
            // be considered illegal css1 as it has to be on the first line
            if (this.charset) {
